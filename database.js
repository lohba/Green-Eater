...
let sql =
  "CREATE TABLE IF NOT EXISTS restaurants (num INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), category VARCHAR(255), location VARCHAR(255), zip VARCHAR(255), coordinates VARCHAR(255), id VARCHAR(255), sustainability INT(255), reviewCount INT(255))";
...
function category(cb) {
  let sql = "SELECT category from restaurants";
  db.query(sql, cb);
}
